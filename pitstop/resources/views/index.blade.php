...
<head>
    ...
    <title>PitStop - Booking Service Bengkel</title>
...
<body class="min-h-screen overflow-x-hidden bg-[#f3f6fb] text-slate-800 antialiased">
    @php
        ...
        $fieldClass = 'min-h-[46px] w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-3 text-slate-800 outline-none transition focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-100';
        $labelClass = 'text-sm font-extrabold text-slate-800';
        $buttonClass = 'inline-flex min-h-[42px] items-center justify-center rounded-lg border-0 px-4 py-3 text-center font-extrabold transition hover:-translate-y-0.5';
    @endphp
    ...
    <section
        ...
        <div class="relative z-10 max-w-3xl">
            <p class="text-xs font-black uppercase tracking-[0.12em] text-amber-400">Booking service bengkel tanpa antre panjang</p>
    ...
    <div class="relative z-10 mx-auto -mt-14 grid w-[min(1400px,90%)] gap-6 lg:grid-cols-[300px_minmax(0,1fr)] lg:items-start">
        <aside id="statistik-section"
            class="grid gap-4 rounded-lg border border-slate-200/90 bg-white p-4 shadow-[0_18px_45px_rgba(14,43,82,0.10)] sm:grid-cols-2 lg:sticky lg:top-[88px] lg:grid-cols-1">
            ...
            <div class="flex items-center gap-4 rounded-lg border border-blue-100 bg-blue-50 p-4">
                <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-white text-xs font-black text-blue-600">#</span>
                <div>
            ...
            <div class="flex items-center gap-4 rounded-lg border border-blue-100 bg-blue-50 p-4">
                <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-white text-xs font-black text-blue-600">Rp</span>
                <div>
            ...
            <div class="flex items-center gap-4 rounded-lg border border-emerald-200 bg-emerald-50 p-4">
                <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-white text-xs font-black text-blue-600">OK</span>
                <div>
        ...
        <main class="grid min-w-0 gap-6">
            <section class="rounded-lg border border-slate-200/90 bg-white p-5 shadow-[0_18px_45px_rgba(14,43,82,0.10)] sm:p-8" id="booking-section">
                <div class="mb-5">
                    <p id="formModeLabel" class="text-xs font-black uppercase tracking-[0.12em] text-amber-500">Form booking service</p>
                    <h2 id="formTitle" class="mt-1 text-2xl font-black leading-tight text-slate-800">Tambah Booking Baru</h2>
                </div>
                ...
                <form id="bookingForm" novalidate>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="form-group grid gap-2">
                            ...
                            <input class="{{ $fieldClass }}" type="text" id="namaPelanggan" placeholder="Masukkan nama pelanggan" autocomplete="off">
                            <small class="error-message" id="namaPelangganError"></small>
                        </div>

                        <div class="form-group grid gap-2">
                            <label class="{{ $labelClass }}" for="nomorPlat">Nomor Plat</label>
                            <input class="{{ $fieldClass }}" type="text" id="nomorPlat" placeholder="Contoh: B 1234 XYZ" autocomplete="off">
                        ...
                        <div class="form-group grid gap-2">
                            ...
                            <input class="{{ $fieldClass }}" type="text" id="merekKendaraan" placeholder="Contoh: Toyota Avanza 2021" autocomplete="off">
                        ...
                        <div class="form-group grid gap-2">
                            ...
                            <input class="{{ $fieldClass }}" type="time" id="jamService" min="08:00" max="17:00">
                    ...
                    <div class="form-group service-group mt-4 grid gap-2" id="serviceGroup">
                        ...
                        <div class="grid gap-3 md:grid-cols-2">
                            @foreach ($services as $service)
                                <label class="service-option flex cursor-pointer items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3.5 transition hover:border-blue-600 hover:bg-blue-50">
                                    <input class="mt-1 h-[18px] w-[18px] accent-blue-600" type="checkbox" name="jenisService" value="{{ $service['name'] }}">
                                    <span class="grid min-w-0 gap-0.5 font-extrabold">
                                        {{ $service['name'] }}
                                        <small class="text-xs font-bold text-slate-500">{{ $service['detail'] }}</small>
                                    </span>
                                </label>
                            @endforeach
                        </div>
                    ...
                    <div class="mt-5 flex flex-wrap gap-3">
                        <button type="button" class="{{ $buttonClass }} bg-blue-600 text-white shadow-[0_12px_24px_rgba(23,105,224,0.22)] hover:bg-blue-950" id="submitButton">
                            Simpan Booking
                        </button>
                        <button type="button" class="{{ $buttonClass }} bg-slate-200 text-blue-950 hover:bg-slate-300" id="resetButton">
                            Reset
                        </button>
                        <button type="button" class="{{ $buttonClass }} bg-slate-200 text-blue-950 hover:bg-slate-300" id="cancelEditButton">
                            Batal Edit
                        </button>
                    </div>
                </form>
            ...
            <section class="rounded-lg border border-slate-200/90 bg-white p-5 shadow-[0_18px_45px_rgba(14,43,82,0.10)] sm:p-8" id="data-section">
                <div class="grid gap-2">
                    <div class="mb-3">
                        <p class="text-xs font-black uppercase tracking-[0.12em] text-amber-500">Antrean dan riwayat</p>
                    ...
                    <div class="mb-4 grid gap-3 md:grid-cols-[1.3fr_1fr_1fr]">
                        <div class="grid gap-1.5">
                            ...
                            <input class="{{ $fieldClass }}" type="search" id="searchInput" placeholder="Nama, kode, atau plat">
                        </div>
                        <div class="grid gap-1.5">
